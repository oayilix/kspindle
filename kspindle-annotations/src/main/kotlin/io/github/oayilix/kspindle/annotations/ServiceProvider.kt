package io.github.oayilix.kspindle.annotations
 ...
 * a [io.github.oayilix.kspindle.runtime.ServiceIndexProvider] that registers them into the
 * [io.github.oayilix.kspindle.runtime.ServiceRegistry] for runtime discovery.
 ...
 *                    by [io.github.oayilix.kspindle.runtime.Kspindle.loadAll].
 *                    Default is 0.
 *                    排序优先级。值越高的实现由 [Kspindle.loadAll] 优先返回。默认值为 0。
 * @property name     An optional logical name for this implementation, enabling
 *                    retrieval by name via [io.github.oayilix.kspindle.runtime.Kspindle.loadByName].
 *                    Default is empty string (unnamed).
 *                    该实现的可选逻辑名称，可通过 [Kspindle.loadByName] 按名称检索。默认值为空字符串（未命名）。
