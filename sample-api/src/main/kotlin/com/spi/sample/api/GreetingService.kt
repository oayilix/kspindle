package com.spi.sample.api

import com.spi.framework.annotations.ServiceProviderInterface
 ...
 * SPI 框架在运行时处理实现的发现，因此业务代码无需直接导入或实例化实现类。
 * 这确保了 API 与实现之间的真正解耦。
 *
 * @see com.spi.sample.impl.EnglishGreeting
 * @see com.spi.sample.impl.SpanishGreeting
 */
